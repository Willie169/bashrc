...
export PATH="$GOPATH/bin:$HOME/.cargo/bin:/opt/TurboVNC/bin:/usr/local/texlive/2025/bin/x86_64-linux:$HOME/KataGo/cpp:$HOME/Fairy-Stockfish/src:$HOME/cutechess/build:$HOME/Sylvan/projects/gui:$HOME/Sylvan/projects/cli:$BUN_INSTALL/bin:$HOME/intelFPGA/20.1/modelsim_ase/bin:/opt/Binance:$HOME/.local/bin:$HOME/.local/sbin:$HOME/.local/share/flatpak/exports/bin:/var/lib/flatpak/exports/bin:$GOROOT/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:/opt/android-studio/bin:$ANDROID_SDK_ROOT/cmdline-tools/latest/bin:$ANDROID_SDK_ROOT/platform-tools:$ANDROID_SDK_ROOT/emulator:$ANDROID_NDK_HOME:$ANDROID_NDK_HOME/toolchains/llvm/prebuilt/linux-x86_64/bin:$PATH"
