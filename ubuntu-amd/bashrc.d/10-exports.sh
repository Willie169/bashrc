...
export PATH="${HOME}/jadx/bin:${HOME}/rar:${GOPATH}/bin:${HOME}/.cargo/bin:/opt/TurboVNC/bin:/usr/local/texlive/2026/bin/x86_64-linux:/usr/local/texlive/2025/bin/x86_64-linux:/usr/local/cuda/bin:${HOME}/dev/llm/llama.cpp/build/bin:${HOME}/KataGo/cpp:${HOME}/Sylvan/projects/gui:${HOME}/Sylvan/projects/cli:${JAVA_HOME}/bin:${HOME}/eclipse.jdt.ls/bin:${HOME}/RuView/v2/target/release/sensing-server:${HOME}/.opencode/bin:${HOME}/intelFPGA/20.1/modelsim_ase/bin:${HOME}/yosys/build:/opt/Binance:${HOME}/.local/share/flatpak/exports/bin:/var/lib/flatpak/exports/bin:${GOROOT}/bin:${ANDROID_HOME}/cmdline-tools/latest/bin:${ANDROID_HOME}/platform-tools:${ANDROID_HOME}/emulator:${HOME}/.local/bin:${HOME}/.local/sbin:/usr/games:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:${PATH:-}"
