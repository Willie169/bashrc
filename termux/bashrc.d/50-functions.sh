...
sccznlc() {
  ...
  scrcpy -s localhost:5555 --no-audio --video-codec=h265 --fullscreen --new-display --start-app app.lawnchair "$@"
  )
}
...
sccznsa() {
  ...
  adb connect localhost:5555
  unset GALLIUM_DRIVER
  scrcpy -s localhost:5555 --no-audio --video-codec=h265 --fullscreen --new-display --start-app "$@"
  )
}
...
scczn() {
  ...
  adb connect localhost:5555
  unset GALLIUM_DRIVER
  scrcpy -s localhost:5555 --no-audio --video-codec=h265 --fullscreen --new-display "$@"
  )
}
...
sccznnn() {
  ...
  adb connect localhost:5555
  unset GALLIUM_DRIVER
  scrcpy -s localhost:5555 --no-audio --video-codec=h265 --fullscreen "$@"
  )
}
