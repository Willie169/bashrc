...
export PATH="$GOPATH/bin:$HOME/.cargo/bin:$JAVA_HOME/bin:$HOME/.local/bin:$HOME/.local/sbin:$GOROOT/bin:$PREFIX/local/bin:$PREFIX/local/sbin:$PREFIX/bin:$PREFIX/sbin:/bin:/sbin:$ANDROID_SDK_ROOT/cmdline-tools/latest/bin:$ANDROID_SDK_ROOT/platform-tools:$ANDROID_NDK_HOME:$ANDROID_NDK_TOOLCHAINS/bin:$PATH"
