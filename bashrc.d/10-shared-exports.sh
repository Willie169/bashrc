...
unset GIT_ASKPASS
export PATH="$HOME/shizuku:$HOME/jadx/bin:$HOME/rar:$GOPATH/bin:$HOME/.cargo/bin:$JAVA_HOME/bin:$HOME/eclipse.jdt.ls/bin:$HOME/ktlsp/server/bin:$HOME/.opencode/bin:$HOME/KataGo/cpp:$HOME/Sylvan/projects/gui:$HOME/Sylvan/projects/cli:/opt/TurboVNC/bin:$HOME/intelFPGA/20.1/modelsim_ase/bin:/opt/Binance:$USR_DIR/local/cuda/bin:$HOME/.local/share/flatpak/exports/bin:/var/lib/flatpak/exports/bin:$HOME/.local/bin:$HOME/.local/sbin:$GOROOT/bin:$USR_DIR/local/bin:$USR_DIR/local/sbin:$USR_DIR/bin:$USR_DIR/sbin:/bin:$USR_DIR/local/games:$USR_DIR/games:/sbin:$ANDROID_HOME/cmdline-tools/latest/bin:$ANDROID_HOME/platform-tools:$ANDROID_HOME/emulator:$HOME/Applications:/system/bin:/snap/bin"
