...
export PATH="$PATH:/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:$HOME/.local/bin:$HOME/.local/sbin:/usr/glibc/bin:$GOPATH/bin:$GOROOT/bin:$HOME/.cargo/bin:/usr/local/texlive/2025/bin/aarch64-linux"
