...
export PATH="$GOPATH/bin:$HOME/.cargo/bin:/usr/local/texlive/2025/bin/aarch64-linux:$HOME/dev/llm/llama.cpp/build/bin:$HOME/KataGo/cpp:$HOME/Fairy-Stockfish/src:$HOME/cutechess/build:$HOME/Sylvan/projects/gui:$HOME/Sylvan/projects/cli:$BUN_INSTALL/bin:$JAVA_HOME/bin:$HOME/eclipse.jdt.ls/bin:$HOME/.local/bin:$HOME/.opencode/bin:$HOME/.local/sbin:$GOROOT/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:$PATH"
