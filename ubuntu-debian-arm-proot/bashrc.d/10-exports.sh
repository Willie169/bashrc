...
export PATH="$GOPATH/bin:$HOME/.cargo/bin:/usr/local/texlive/2025/bin/aarch64-linux:$HOME/KataGo/cpp:$BUN_INSTALL/bin:$HOME/.local/bin:$HOME/.local/sbin:$GOROOT/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:$PATH"
